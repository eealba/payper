...
public abstract class PayperProvider {
     ...
     */
    private static final String DEFAULT_PROVIDER = "io.github.eealba.payper.core.client.internal.PayperProviderImpl";
    ...
    public abstract <T1, R1, R2> Spec.Builder<T1, R1, R2> createSpecBuilder(Class<T1> clazz, Payper payper, String path,
