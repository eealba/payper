 ...
 */
public record CustomerRec(String name, String lastName, Integer id, LocalDate birthday, BigDecimal credit, Boolean active, Instant created, Frequency frequency, List<Link> links) {

    public CustomerRec(String name, String lastName, Integer id, LocalDate birthday, BigDecimal credit, Boolean active, Instant created, Frequency frequency, List<Link> links) {
        if (name == null) {
