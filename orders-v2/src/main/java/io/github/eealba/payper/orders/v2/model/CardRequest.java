...
href="https://www.pcisecuritystandards.org/pci_security/completing_self_assessment"> PCI SAQ D compliance</a>. 
<br>*PayPal offers a mechanism by which you do not have to take on the <strong>PCI SAQ D</strong> burden by using hosted 
fields - refer to <a href="https://developer.paypal.com/docs/checkout/advanced/integrate/">this Integration 
Guide</a>*.</blockquote>
 */
public class CardRequest {
    ...
    @JasonerProperty("network_token")
    private final NetworkTokenRequest networkToken;
    @JasonerProperty("experience_context")
    private final CardExperienceContext experienceContext;
    ...
    private CardRequest(Builder builder) {
        ...
        networkToken = builder.networkToken;
...
parameter cannot be present in the request when `payment_initiator=MERCHANT`.
     ...
     */
    @JasonerProperty("network_token")
    public NetworkTokenRequest networkToken() {
        return networkToken;
    }
     ...
     */
    @JasonerProperty("experience_context")
    public CardExperienceContext experienceContext() {
...
parameter cannot be present in the request when `payment_initiator=MERCHANT`.
         ...
         */
        @JasonerProperty("network_token")
        public Builder networkToken(NetworkTokenRequest value) {
         ...
         */
        @JasonerProperty("experience_context")
        public Builder experienceContext(CardExperienceContext value) {
